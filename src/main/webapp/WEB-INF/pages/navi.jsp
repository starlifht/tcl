...
<head>
    ...
    <style>
        ...
        .logo{color: grey;font-size: 80px;font-weight: bold;}
        .master{width: 900px;height: 800px;text-align: center; line-height:120px;margin-right: auto;margin-left: auto; margin-top: 100px; }
        .pan{cursor:pointer;font-size: 33px;color: whitesmoke;font-weight:bold;margin:0 5px 5px 0}
        .pan:hover{opacity:0.8;-webkit-box-shadow:  0 0 20px #909090;-moz-box-shadow: 0 0 20px 909090}
        .pan1{background: red;width: 330px;float:left;}
        .pan2{background: dodgerblue;float: left;width: 560px}
        .pan3{background: orange;width: 300px;float: left}
        .pan4{background: gold;width: 200px;float: left}
        .pan5{background: hotpink;width: 385px;float: left}
    </style>
